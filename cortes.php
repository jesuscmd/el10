...
//Seleccionar la Base de Datos a utilizar
    ...
    $result = mysql_query("SELECT * FROM menu where categoria = 'CORTES DEL ASADOR SELECCION ESPECIAL' OR categoria ='CORTES DEL ASADOR (res U.S. CHOICE)' OR categoria='CORTE + PASTA' ORDER BY id DESC");	
